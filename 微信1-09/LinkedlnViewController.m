...
@interface LinkedlnViewController ()
{
...
@implementation LinkedlnViewController
...
-(void)layout{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(140,10 ,140 , 30)];
    label.text = @"Linkedln账号";
    ...
    imageView.image = [UIImage imageNamed:@"linkedln"];
